...
ALTER TABLE trading.balances ADD CONSTRAINT fk_balances_exchange FOREIGN KEY (exchange_id)
    REFERENCES trading.exchanges(id) ON UPDATE CASCADE ON DELETE RESTRICT;
ALTER TABLE trading.balances ADD CONSTRAINT fk_balances_asset FOREIGN KEY (asset_id)
