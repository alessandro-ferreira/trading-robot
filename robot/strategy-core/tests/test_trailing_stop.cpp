...
class TrailingStopTest : public ::testing::Test {
   protected:
    ...
    TrailingStopExitRule rule_{0.10, 0.05, 0.03};
    MockMarketState state_;
};

TEST_F(TrailingStopTest, DoesNotTriggerOnFavorablePriceMove) {
...
TEST_F(TrailingStopTest, TriggersOnStopLoss) {
...
TEST_F(TrailingStopTest, DoesNotTriggerWhenPriceIsAboveStopLoss) {
...
TEST_F(TrailingStopTest, TriggersOnTrailingStop) {
...
TEST_F(TrailingStopTest, DoesNotTriggerWhenAboveTrailingStop) {
...
TEST_F(TrailingStopTest, ActivationPreventsRevertingToFlatStop) {
