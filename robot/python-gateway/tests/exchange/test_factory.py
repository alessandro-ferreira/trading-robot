...
from exchange.factory import ExchangeFactory, ExchangeNotConfigured, ExchangeConfigurationError
...
class TestExchangeFactory(unittest.TestCase):
    ...
    def test_get_sandbox_mode_not_supported_raises(self):
        ...
        cfg = config.Config()
        cfg.exchanges = [
            ExchangeConfig(name='mercadobitcoin', api_key='', secret='', sandbox_mode=True),
        ]
